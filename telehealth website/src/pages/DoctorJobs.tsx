        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          {submitted ? (
            <div className="bg-white rounded-3xl border border-[#E2EBF6] p-10 text-center shadow-sm">
              ...
              <p className="text-[#64748B]">Thank you for applying, Dr. {form.lastName || 'Smith'}. Our medical team will review your application and be in touch within 2 business days.</p>
            </div>
          ) : (
            <div className="bg-white rounded-3xl border border-[#E2EBF6] p-8 shadow-sm">
              ...
              <button
                ...
                className="mt-6 w-full py-4 bg-gradient-to-r from-[#0A6EBD] to-[#0099A8] text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-blue-200 transition-all hover:-translate-y-0.5 text-lg"
              >
                Apply Now →
              </button>
